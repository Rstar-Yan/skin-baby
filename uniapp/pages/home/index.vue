...
import { userInfo, todayStatus as mockTodayStatus, recentRecords, triggerInsight } from '@/utils/mock-data.js'
import StatusCard from '@/components/StatusCard.vue'

const userInfo = ref(mockTodayStatus ? { name: '小贝壳' } : { name: '小贝壳' })
const todayStatus = reactive({ ...mockTodayStatus })
const recentRecords = ref([...recentRecords])
const triggerInsightData = ref({ ...triggerInsight })

// Fix user info
const initUser = () => {
  const mock = require('@/utils/mock-data.js')
  userInfo.value = mock.userInfo
}
initUser()
